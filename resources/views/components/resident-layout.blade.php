...
<body class="font-sans antialiased bg-gray-100 ">
    <svg xmlns="http://www.w3.org/2000/svg" class="fixed top-0 left-0 bottom-0 h-full w-full opacity-20" version="1.1"
        xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" width="1440" height="800"
    ...
    <div class="border-b bg-white z-50  sticky top-0 ">
        <div class="w-full mx-auto 2xl:max-w-7xl">
            <div x-data="{ open: false }"
                ...
                <div class="flex flex-row items-center justify-between lg:justify-start">
                    <a class="text-lg tracking-tight text-blue-700 font-bold uppercase focus:outline-none focus:ring lg:text-2xl"
                        href="/">
                                    ...
                                    <div class="flex space-x-5 items-center ">
                                        <div class="flex flex-col text-left">
                                            <h1 class="font-bold group-hover:text-blue-700 uppercase">
                                                {{ auth()->user()->name }}</h1>
                                            <span
                                                class="leading-3 text-gray-500 text-sm">{{ auth()->user()->email }}</span>
                                        </div>
                                        <div>
    ...
    <div class="mx-auto max-w-7xl p-10 relative">
        <div>
            {{ $slot }}
        </div>
    </div>
