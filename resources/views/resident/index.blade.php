<x-resident-layout>
    <div class="bg-white  p-5 shadow rounded-xl">
        ...
        @if (auth()->user()->resident->status == 'pending')
            <div>
                <div class="flex py-20 flex-col space-y-2 justify-center items-center">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" class="h-96"
                        ...
                        <path
                            ...
                            transform="translate(-384.54297 -170.14522)" fill="#6c63ff" />
                        <path
                    ...
                    <h1 class="font-bold text-red-700 animate-pulse text-xl">PLEASE WAIT FOR THE VERIFICATION OF ADMIN.
                    </h1>
                    <span class="text-gray-500">You are able to request any certification once your status is
                        accepted.</span>
                </div>
            </div>
        @else
